		...
		extend: {
			colors: {
				...
				quiz: {
					...
					'selected-foreground': 'hsl(var(--quiz-selected-foreground))',
					...
					'number-selected': 'hsl(var(--quiz-number-selected))',
					'number-selected-foreground': 'hsl(var(--quiz-number-selected-foreground))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
